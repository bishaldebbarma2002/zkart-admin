...
/***/ "(api)/./pages/api/admins.js":
/*!*****************************!*\
  !*** ./pages/api/admins.js ***!
  \*****************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ handle)\n/* harmony export */ });\n/* harmony import */ var _lib_mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/lib/mongoose */ \"(api)/./lib/mongoose.js\");\n/* harmony import */ var _pages_api_auth_nextauth___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/pages/api/auth/[...nextauth] */ \"(api)/./pages/api/auth/[...nextauth].js\");\n/* harmony import */ var _models_Admin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/models/Admin */ \"(api)/./models/Admin.js\");\n\n\n\nasync function handle(req, res) {\n    await (0,_lib_mongoose__WEBPACK_IMPORTED_MODULE_0__.mongooseConnect)();\n    await (0,_pages_api_auth_nextauth___WEBPACK_IMPORTED_MODULE_1__.isAdminRequest)(req, res);\n    if (req.method === \"POST\") {\n        const { email  } = req.body;\n        if (await _models_Admin__WEBPACK_IMPORTED_MODULE_2__.Admin.findOne({\n            email\n        })) {\n            res.status(400).json({\n                message: \"admin already exists!\"\n            });\n        } else {\n            res.json(await _models_Admin__WEBPACK_IMPORTED_MODULE_2__.Admin.create({\n                email\n            }));\n        }\n    }\n    if (req.method === \"DELETE\") {\n        const { _id  } = req.query;\n        await _models_Admin__WEBPACK_IMPORTED_MODULE_2__.Admin.findByIdAndDelete(_id);\n        res.json(true);\n    }\n    if (req.method === \"GET\") {\n        res.json(await _models_Admin__WEBPACK_IMPORTED_MODULE_2__.Admin.find());\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/admins.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/admins.js"));
